...
namespace Investa.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Investments",
                columns: new[] { "Id", "AvailableShares", "BusinessCategoryId", "BusinessName", "BusinessStageId", "ContractCompletionStatus", "ContractEndDate", "ContractStartDate", "Currency", "CurrentValuation", "Date", "DefaultRiskLevel", "Description", "DurationMonths", "EndDate", "EquityExitType", "EstimatedFutureValuation", "ExitTargetDate", "ExpectedExitStrategy", "ExpectedROI", "FinalRepaymentDate", "FounderId", "ImageUrl", "InitialCapital", "InvestmentTypeId", "LastActivityAt", "LoanCompletionStatus", "MaxInvestment", "Milestone", "MinInvestment", "MomentumScore", "NextInstallmentDate", "ParticipantOnlyActivityCount", "PayoutFrequency", "ProfitPercentage", "ProjectPhaseId", "PublicActivityCount", "RemainingBalance", "RemainingPayoutAmount", "RepaymentStartDate", "RevenueDistributionFrequency", "RiskLevel", "SharePrice", "StartDate", "Status", "TargetFund", "TotalExpectedPayout", "TotalPaidAmount", "TotalShares", "ValuationCap", "VideoUrl" },
                values: new object[,]
                {
                    { 1000, 8000, 100, "SolarGrid Energy", null, null, null, null, "USD", null, new DateTime(2025, 12, 29, 0, 0, 0, 0, DateTimeKind.Utc), null, "Distributed solar microgrid for emerging markets.", null, new DateTime(2026, 1, 28, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, null, 12.5m, null, new Guid("11111111-1111-1111-1111-111111111111"), null, 50000m, 2, null, null, 5000m, null, 100m, 0, null, 0, null, null, null, 0, null, null, null, null, "Medium", 10.00m, new DateTime(2025, 12, 15, 0, 0, 0, 0, DateTimeKind.Utc), "Active", 100000m, null, null, 10000, 5000000m, null },
                    { 1001, 1200, 101, "AquaPure", null, null, null, null, "USD", null, new DateTime(2025, 12, 29, 0, 0, 0, 0, DateTimeKind.Utc), null, "Affordable water purification devices.", null, new DateTime(2026, 1, 12, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, null, 10.0m, null, new Guid("11111111-1111-1111-1111-111111111111"), null, 20000m, 2, null, null, 2000m, null, 50m, 0, null, 0, null, null, null, 0, null, null, null, null, "Low", 5.00m, new DateTime(2025, 12, 22, 0, 0, 0, 0, DateTimeKind.Utc), "Active", 25000m, null, null, 5000, 2000000m, null }
                });
