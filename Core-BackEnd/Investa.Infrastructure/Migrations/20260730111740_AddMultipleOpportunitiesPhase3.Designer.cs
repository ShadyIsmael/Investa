...
namespace Investa.Infrastructure.Migrations
{
    ...
    [Migration("20260730111740_AddMultipleOpportunitiesPhase3")]
    partial class AddMultipleOpportunitiesPhase3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Investa.Domain.Entities.OpportunityJoinRequest", b =>
                {
                    ...
                    b.Property<int>("ActiveRequestSlot")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("int")
                        .HasComputedColumnSql("CASE WHEN [Status] IN ('Pending', 'Approved') THEN 0 ELSE [Id] END", true);
