...
var rand = new Random();
// default to start of current month so generated transactions fall into this month
var startDate = new DateTime(DateTime.UtcNow.Year, DateTime.UtcNow.Month, 1);
var endDate = DateTime.UtcNow;

int created = 0;

// Optional: accept number of transactions as third arg
int toCreate = 6;
if (args.Length > 2 && int.TryParse(args[2], out var parsedCount) && parsedCount > 0)
{
    toCreate = parsedCount;
}
