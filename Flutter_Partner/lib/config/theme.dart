...
class AppTheme {
  // Core Brand Colors
  static const Color primaryColor = Color(0xFF0F172A); // Slate 900 (Luxury Dark)
  static const Color primaryAccent = Color(0xFF3B82F6); // Blue 500 (Vibrant action)
  static const Color secondaryColor = Color(0xFF10B981); // Emerald 500 (Success/Growth)
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      textTheme: GoogleFonts.outfitTextTheme(
        ...
        displayLarge: GoogleFonts.outfit(fontWeight: FontWeight.w700, color: const Color(0xFF0F172A)),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      textTheme: GoogleFonts.outfitTextTheme(
        ...
        displayLarge: GoogleFonts.outfit(fontWeight: FontWeight.w700, color: const Color(0xFFF8FAFC)),
        titleLarge: GoogleFonts.outfit(fontWeight: FontWeight.w600, color: const Color(0xFFF8FAFC)),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: GoogleFonts.outfit(color: const Color(0xFF94A3B8)), // Slate 400
      ),
