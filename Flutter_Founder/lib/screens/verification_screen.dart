...
import 'package:flutter_founder/services/trust_service.dart';
import 'package:flutter_founder/widgets/trust_badge_widget.dart';
...
class _VerificationScreenState extends State<VerificationScreen> {
    ...
    return ListView(
      ...
      children: [
              ...
              children: [
                ...
                LinearProgressIndicator(
                  ...
                  valueColor: AlwaysStoppedAnimation<Color>(
                    p.profileCompletionPercentage >= 60
                        ? Colors.green
                        : Colors.blue,
                  ),
                ),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Reputation: ${p.reputationScore}/10000',
                        style:
        ...
        _VerificationItem(
          ...
          onTap: p.isEmailVerified
              ? null
              : () => _submitVerification(VerificationType.email),
        ),
        _VerificationItem(
          label: 'Phone Verified',
          icon: Icons.phone_outlined,
          isDone: p.isPhoneVerified,
          onTap: p.isPhoneVerified
              ? null
        ...
        if (p.nextLevelRequirements.isNotEmpty) ...[
          const SizedBox(height: 16),
          const Text('What\'s needed to level up:',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
          const SizedBox(height: 8),
  ...
  Future<void> _submitVerification(VerificationType type) async {
    final ok =
        await _trustService.submitVerification(verificationType: type.value);
    if (ok && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('Verification submitted! Awaiting review.')));
      _loadProfile();
    }
  }
}
