...
class TrustGateWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return fallback ??
        _UpgradePrompt(requiredLevel: requiredLevel, profile: profile);
  }
}
...
class _UpgradePrompt extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color =
        requiredLevel == TrustLevel.trustedActive ? Colors.green : Colors.blue;
