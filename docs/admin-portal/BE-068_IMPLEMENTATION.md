...
**Component:** [components/UserOnboarding.tsx](../../investa-admin-portal/src/components/UserOnboarding.tsx)
...
**Component:** [components/GroupsRoles.tsx](../../investa-admin-portal/src/features/rbac/GroupsRoles.tsx)
...
### Files Created:
1. **[components/UserOnboarding.tsx](../../investa-admin-portal/src/components/UserOnboarding.tsx)** - 360 lines
...
### Files Modified:
1. **[src/types/index.ts](../../investa-admin-portal/src/types/index.ts)**
   - Added `groupId`, `roleId`, `groupName`, `roleName` to User interface
   - Deprecated legacy `role` field with @deprecated tag

2. **[services/groupService.ts](../../investa-admin-portal/src/services/groupService.ts)**
...
3. **[components/GroupsRoles.tsx](../../investa-admin-portal/src/features/rbac/GroupsRoles.tsx)**
...
4. **[components/UsersList.tsx](../../investa-admin-portal/src/features/rbac/UsersList.tsx)**
...
5. **[services/userService.ts](../../investa-admin-portal/src/services/userService.ts)**
