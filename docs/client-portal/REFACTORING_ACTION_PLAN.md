...
1. **Dead Code - Mobile Menu Logic**
   ...
   - **Files affected**:
     - [src/app/components/header/header.component.ts](../../investa-client-portal/src/app/components/header/header.component.ts)
     - [src/app/components/header/header.component.html](../../investa-client-portal/src/app/components/header/header.component.html)
...
2. **Duplicate Code - Language Toggle**
   ...
   - **Files affected**:
     - [src/app/components/header/header.component.ts](../../investa-client-portal/src/app/components/header/header.component.ts)
     - [src/app/components/admin-navbar/admin-navbar.component.ts](../../investa-client-portal/src/app/components/admin-navbar/admin-navbar.component.ts)
...
3. **Inconsistent Styling Patterns**
   ...
   - **Files affected**:
     ...
     - [src/styles/_variables.scss](../../investa-client-portal/src/styles/_variables.scss)
...
5. **Inconsistent Navbar Styling (PARTIALLY FIXED)**
   ...
   - **Files affected**:
     - [src/app/components/header/header.component.scss](../../investa-client-portal/src/app/components/header/header.component.scss)
     - [src/app/components/admin-navbar/admin-navbar.component.scss](../../investa-client-portal/src/app/components/admin-navbar/admin-navbar.component.scss)
...
**File**: [src/app/components/header/header.component.scss](../../investa-client-portal/src/app/components/header/header.component.scss)
...
**File**: [src/app/components/admin-navbar/admin-navbar.component.scss](../../investa-client-portal/src/app/components/admin-navbar/admin-navbar.component.scss)

Same pattern as header (unified styling)

#### 4.3 Update Dashboard Component SCSS
**File**: [src/app/pages/admin/dashboard/dashboard.component.scss](../../investa-client-portal/src/app/pages/admin/dashboard/dashboard.component.scss)
...
Update [src/app/components/header/header.component.ts](../../investa-client-portal/src/app/components/header/header.component.ts) and [src/app/components/admin-navbar/admin-navbar.component.ts](../../investa-client-portal/src/app/components/admin-navbar/admin-navbar.component.ts) to inject and use this service.
...
- Build Config: [tailwind.config.cjs](../../investa-client-portal/tailwind.config.cjs), [tsconfig.json](../../investa-client-portal/tsconfig.json)
